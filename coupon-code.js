...
(function () {
    ...
    _CouponCode.generate = function(opts) {
    ...
    _CouponCode.validate = function(code, opts) {
        if ( !code ) {
    ...
    _CouponCode.hasBadWord = hasBadWord

    if (typeof Package !== 'undefined') {
        CouponCode = _CouponCode;
    } else if (typeof module !== 'undefined' && module.exports) {
        module.exports = _CouponCode;
    } else {
        root.CouponCode = _CouponCode;
    }
    // --------------------------------------------------------------------------------------------------------------------
}());
